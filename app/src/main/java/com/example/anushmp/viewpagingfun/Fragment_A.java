...
public class Fragment_A extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        et = view.findViewById(R.id.etdata);
        ...
        btngo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Bundle datatofrag2 = new Bundle();
                //datatofrag2.putString("data",et.getText().toString());

                //flistner.onclick(datatofrag2);

                mainct.setData(et.getText().toString());
                mainct.setcurrentitem(1);
    ...
    public void onAttach(@NonNull Context context) {
        ...
        flistner = (fragcommslistner) context;
        mainct = (MainActivity) context;
    }
}